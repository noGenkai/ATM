...
function authenticatePinForLogIn1() {
  ...
  if (checkPin != pin.value) {
    confirmPin.textContent =
      "This is the incorrect pin for " + username.value + ".";
  } else {
    confirmPin.textContent =
      "You have successfully logged into your account, " + username.value + ".";
...
function checking2() {
  ...
  output2.textContent =
    "You have successfully created a CHECKING account named " +
    checkingAccName.value +
    ".";
...
function savings2() {
  ...
  output3.textContent =
    "You have successfully created a SAVINGS account named " +
    savingsAccName.value +
    ".";
